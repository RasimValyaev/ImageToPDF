...
files_to_send = [
    r"\\PRESTIGEPRODUCT\Scan\ЕСП - Copy\Resize\РН 11070 21.03.3023.pdf",
    r"\\PRESTIGEPRODUCT\Scan\ЕСП - Copy\Resize\image1_1.png"
]
...
# your credentials
email = "rascrimea@gmail.com"
password = "AhSaMer_15"

# the sender's email
FROM = email
# the receiver's email
TO   = "rascrimea@gmail.com"
